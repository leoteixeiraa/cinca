...
export declare class ImageUploaderComponent implements OnInit, OnDestroy, AfterViewChecked, ControlValueAccessor {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<ImageUploaderComponent>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<ImageUploaderComponent, "ngx-image-uploader", never, {
    "options": "options";
}, {
    "upload": "upload";
...
//# sourceMappingURL=image-uploader.component.d.ts.map